	...
	public void desenhar(Tela t) {
		...
		switch (game_state) {
			...
			case 2:
				...
				if (vida == 0) {
					t.imagem("obj/heart.png", 0, 0, 19, 17, 0, getLargura()/1.32, 3);
					t.imagem("obj/heart.png", 0, 0, 19, 17, 0, getLargura()/1.20, 3);
					t.imagem("obj/heart.png", 0, 0, 19, 17, 0, getLargura()/1.10, 3);
				}
